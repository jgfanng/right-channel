    ...
    function manipulateView(movies) {
        ...
        for (var i = 0; i < movies.length; i++) {
            ...
            var bottomBadge = '<div class="poster-badge poster-badge-bottom">'
                ...
                +                '</div>'
                +            '</div>';
            var interestBtn = '<a title="想看" class="interest-btn interest-btn-wish hide" data-interest-type="wish" href="javascript:void(0)"></a>'
                +             '<a title="没兴趣" class="interest-btn interest-btn-dislike hide" data-interest-type="dislike" href="javascript:void(0)"></a>';
