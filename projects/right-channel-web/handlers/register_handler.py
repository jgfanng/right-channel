...
class RegisterHandler(BaseHandler):
    ...
    def post(self):
        ...
        # TODO: validate password, nick name
        response, error = yield tornado.gen.Task(collections['accounts'].insert, {'email': email, 'password': encrypt(password), 'nick_name': nick_name})
